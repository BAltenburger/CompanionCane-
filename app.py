...
def sms():
    ...
    elif read_data("user_number.txt") == str(number) and message[0:4] == "age:" and read_data(number + "service_order.txt") == "1":
    ...
    elif read_data("user_number.txt") == str(number) and message[0:7] == "gender:" and read_data(number + "service_order.txt") == "2":
    ...
    elif read_data("user_number.txt") == str(number) and message[0:7] == "weight:" and read_data(number + "service_order.txt") == "3":
        try:
    ...
    elif read_data("user_number.txt") == str(number) and message[0:3] == "EC:" and read_data(number + "service_order.txt") == "4":
        try:
    ...
    elif read_data("user_number.txt") == str(number) and message[0:3] == "PC:" and read_data(number + "service_order.txt") == "5":
        try:
            int(message[3:len(message)])
            if len(message[3:len(message)]) == 11 or len(message[3:len(message)]) == 10:
    ...
    elif read_data("user_number.txt") == str(number) and message[0:6] == "email:" and read_data(number + "service_order.txt") == "6":
        if message.find("@") == -1:
    ...
    elif read_data("user_number.txt") == str(number) and message[0:4] == "STOP" and read_data(number + "service_order.txt") == "7":
