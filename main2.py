...
def check():  
    ...
    while thread1.is_alive():
        compressed=pd.read_csv("new_data.csv",chunksize=100000,parse_dates = True)
        ...
        if Cane_fall2 and Cane_fall and l>l3:                
            while l>index and l>3:
                ...
                if fg>50: #or hr>100:
                    Cane_fall=False
                    l-=600
                    print("fall detection cancelled")
                l-=1
            if (sc>199 or oc>199) and Cane_fall:
                graphing
